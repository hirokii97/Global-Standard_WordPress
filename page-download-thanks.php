      ...
      <div class="download__page__apply">
        ...
        <!--送信後メッセージ-->
           <div class="download__page__apply__form__afterSend">
            ...
            <div class="download__page__apply__form__afterSend__sentence-wrapper">
              <p class="download__page__apply__form__afterSend__sentence">資料は以下のリンクよりダウンロードください。<br><br></p>
              <div class="download__page__apply__form__afterSend__link">
              ...
              <p class="download__page__apply__form__afterSend__sentence last">また、ご入力いただいたメールアドレスの方へもダウンロードリンクを送付しておりますので、ご確認いただけますと幸いです。</p>
            </div>
          </div>
          </form>
      </div>

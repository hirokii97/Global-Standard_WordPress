    ...
    <div class="p-top swiper-container">
      <div class="swiper-wrapper">
        <div class="p-top__contents top-mv1 swiper-slide">
          <div class="p-top__message">
            ...
            <div class="p-top__message-subtitle">世界で活躍できるグローバルな人材を育てる</div>
          </div>
        </div>
        <div class="p-top__contents top-mv2 swiper-slide">
          <div class="p-top__message">
            <div class="p-top__message-title c-english-title">
              <div class="p-top__message-item message-title1 c-title-type2">YOU CAN <span class="pc-message-title">CHANGE</span></div>
              <div class="p-top__message-item message-title2 c-title-type2"> CHANGE</div>
        ...
        <div class="p-top__contents top-mv3 swiper-slide">
          <div class="p-top__message">
            <div class="p-top__message-title c-english-title">
              <div class="p-top__message-item message-title1 c-title-type2">YOU CAN <span class="pc-message-title">CHANGE</span></div>
              <div class="p-top__message-item message-title2 c-title-type2"> CHANGE</div>
      ...
      <div class="service__inner l-inner">
        <div class="service__wrapper"> 
          <div class="l-title">
            ...
            <div class="l-view-more-pc c-view-more"><a class="c-view-more-link" href="<?php echo home_url('/service') ?>">
    ...
    <div class="case-study">
      <div class="case-study__inner l-inner">
    ...
    <div class="news news-background">
